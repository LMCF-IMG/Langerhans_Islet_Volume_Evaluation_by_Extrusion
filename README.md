...
Volume from contours by Vmod or Vext [µm3], [nl], [IEQ];  
Volume from size by Spherical model, Vsphe [nl], [IEQ];  
Volume from size by Ricordi conversion table, Vrico [nl], [IEQ];  
(IEQ = Islet Equivalent ~ 1.7671 nL)  
